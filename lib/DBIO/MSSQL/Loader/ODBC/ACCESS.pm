package DBIO::MSSQL::Loader::ODBC::ACCESS;
# ABSTRACT: MS Access via ODBC introspection

use strict;
use warnings;
use base 'DBIO::Loader::ODBC';
use mro 'c3';
use Try::Tiny;
use namespace::clean;
...
DBIO::MSSQL::Loader::ODBC::ACCESS - Microsoft Access driver for
DBIO::Loader
