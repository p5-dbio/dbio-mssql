package DBIO::MSSQL::Loader::SQLAnywhere;
# ABSTRACT: SQL Anywhere introspection for DBIO::Loader
...
DBIO::MSSQL::Loader::SQLAnywhere - DBIO::Loader::DBI
...
EOF
    ...
    while (my ($fk, $local_col, $remote_schema, $remote_tab, $remote_col, $on_delete, $on_update)
        ...
        $remote_table->{$fk} = DBIO::Loader::Table->new(
            loader  => $self,
            name    => $remote_tab,
