package DBIO::MSSQL::Loader::ADO::MS_Jet;
# ABSTRACT: MS Access/Jet via ADO introspection
...
DBIO::MSSQL::Loader::ADO::MS_Jet - ADO wrapper for
L<DBIO::MSSQL::Loader::ODBC::ACCESS>

=head1 DESCRIPTION

Proxy for L<DBIO::MSSQL::Loader::ODBC::ACCESS> when using
L<DBD::ADO>.
