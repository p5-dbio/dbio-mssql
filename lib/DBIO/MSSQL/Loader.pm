package DBIO::MSSQL::Loader;
# ABSTRACT: Microsoft SQL Server introspection for DBIO::Loader

use strict;
use warnings;
use base 'DBIO::Loader::DBI::Sybase::Common';
use mro 'c3';
use Try::Tiny;
use List::Util 'any';
use namespace::clean;

use DBIO::Loader::Table::Sybase ();



=head1 NAME

DBIO::MSSQL::Loader - DBIO::Loader::DBI MSSQL Implementation.

=head1 DESCRIPTION

Base driver for Microsoft SQL Server, used by
L<DBIO::MSSQL::Loader::Sybase::Microsoft_SQL_Server> for support
via L<DBD::Sybase> and
L<DBIO::MSSQL::Loader::ODBC::Microsoft_SQL_Server> for support via
L<DBD::ODBC>.

See L<DBIO::Loader> and L<DBIO::Loader::Base> for
usage information.
...
included in L<db_schema|DBIO::Loader::Base/db_schema>, and set
...
See L<preserve_case|DBIO::Loader::Base/preserve_case>.
...
EOF
            ...
            TABLE: foreach my $table_name (@$table_names) {
                ...
                push @tables, DBIO::Loader::Table::Sybase->new(
                    loader   => $self,
                    name     => $table_name,
                    database => $db,
                    schema   => $owner,
...
EOF
    ...
    while (my ($fk, $remote_schema, $remote_table, $col, $remote_col,
        ...
        $rels{$fk}{remote_table} = DBIO::Loader::Table::Sybase->new(
            loader   => $self,
            name     => $remote_table,
            database => $db,
...
L<DBIO::MSSQL::Loader::Sybase::Microsoft_SQL_Server>,
